...
exports.handler = (event, context, callback) => {
  ...
  if (secret !== null && username !== null) {
    ...
    const message = `${body.supporter_name || 'Somebody'} just send me ☕️ ${body.number_of_coffees === 1 ? 'one coffee' : `${body.number_of_coffees} coffees`} on BuyMeACoffee.com/${username}`;
